...
Docker 采用了 `C/S` 架构（Client/Server），包括客户端和服务端。Docker 守护进程 （`Daemon`）作为服务端接受来自客户端的请求，并处理这些请求（创建、运行、分发容器）。

客户端和服务端既可以运行在一个机器上，也可通过 `socket` 或者 `RESTful API` 来进行通信。

![Docker 基本架构](https://yeasy.gitbook.io/~gitbook/image?url=https:%2F%2F1881212762-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-M5xTVjmK7ax94c8ZQcm%252Fuploads%252Fgit-blob-64df422e5753f422b6b2c91fd2574e4162650d42%252Fdocker_arch.png%3Falt=media&width=768&dpr=1&quality=100&sign=78f854be131af846a0695e64ecd39a4670103c0a825968c9274ee4a56adae7a8)
